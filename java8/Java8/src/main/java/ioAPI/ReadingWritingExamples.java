...
//        copyBinaryFile(false);
    ...
    public static void copyTextFile(boolean buffering) {
        File src = new File("C:\\Users\\marko.dragicevic\\learning\\java8\\Java8\\src\\main\\java\\ioAPI\\ReadingWritingExamples.java");
        File dest = new File("C:\\Users\\marko.dragicevic\\learning\\java8\\Java8\\src\\main\\java\\ioAPI\\ReadingWritingExamples2.java");

        // in-built close() with try-with-resources
        try (BufferedReader rdr = new BufferedReader(new FileReader(src));
             BufferedWriter wtr = new BufferedWriter(new FileWriter(dest))) {
    ...
    public static void copyBinaryFile(boolean buffering) {
        ...
        File src = new File("./target/classes/ioAPI/ReadingWritingExamples.class");
        File dest = new File("./target/classes/ioAPI/ReadingWritingExamples2.class");
