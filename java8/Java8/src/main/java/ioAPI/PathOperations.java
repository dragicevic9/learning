...
public class PathOperations {
    public static void main(String[] args) {
        pathInfo(Paths.get("C:\\Users\\marko.dragicevic\\learning\\java8\\Java8\\pom.xml"));
//        pathInfo(Paths.get("abc\\def\\ghi\\jkl"));
    }
...
//        System.out.println("exception: " + Paths.get("/").getName(0)); // java.lang.IllegalArgumentException
